            ...
            <div class="state-grid">
                ...
                <div class="state-row">
                    ...
                    <span
                        class="value"
                        :class="{
                            active: props.hasAudio,
                            inactive: !props.hasAudio,
                        }"
                    >
                ...
                <div class="state-row" v-if="props.hasAudio">
                    ...
                    <span class="value"
                        >{{ (props.currentTime ?? 0).toFixed(2) }}s /
                        {{ (props.duration ?? 0).toFixed(2) }}s</span
                    >
                </div>
                ...
                <div
                    class="state-row"
                    v-if="props.isExporting && props.exportProgress"
                >
                    <span class="key">导出进度</span>
                    <span class="value">
                        {{ props.exportProgress.currentFrame }}/{{
                            props.exportProgress.totalFrames
                        }}
                ...
                <div class="state-row" v-if="props.visualizerConfig">
                    ...
                    <span class="value">{{
                        props.visualizerConfig.particleCount
                    }}</span>
                </div>
                <div class="state-row" v-if="props.visualizerConfig">
                ...
                <div class="state-row" v-if="props.latestSpectrum">
                    ...
                    <span class="value">
                        avg={{
                            (props.latestSpectrum.averageEnergy * 100).toFixed(
                                1,
                            )
                        }}%, bass={{
                            (props.latestSpectrum.bassEnergy * 100).toFixed(1)
                        }}%
                    </span>
                </div>
                <div class="state-row" v-if="props.latestBeat">
                    ...
                    <span
                        class="value"
                        :class="{ active: props.latestBeat.isBeat }"
                    >
                        {{
                            props.latestBeat.isBeat
                                ? "💥 节拍! intensity=" +
                                  props.latestBeat.intensity.toFixed(2)
                                : "—"
                        }}
                    </span>
                </div>
        ...
        <section class="debug-section debug-console">
            ...
            <div class="console-log-list" ref="listRef">
                ...
                >
                    ...
                    <span
                        class="entry-msg"
                        :class="{ expanded: expandedLogs.has(entry.id) }"
                        >{{ entry.message }}</span
                    >
                </div>
            </div>
